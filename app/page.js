...
export default function Page() {
  ...
  const filteredBeats = useMemo(() => {
    return beats.filter((beat) => {
      const haystack =
        `${beat.title} ${beat.subtitle} ${beat.mood} ${beat.genre} ${beat.key} ${beat.artistType}`.toLowerCase();
    ...
    <main style={styles.page}>
          ...
          <div style={styles.heroImageBox}>
            <div style={styles.heroImageInner}>
              ...
              <div style={styles.heroImagePlaceholder}>
                REPLACE THIS BOX WITH YOUR PHOTO LATER
              </div>
              <WaveBars />
            </div>
          </div>
      ...
      <section style={styles.sectionDark}>
        <div style={styles.aboutGrid}>
          <div style={styles.aboutImage}>YOUR PRODUCER PHOTO GOES HERE</div>
